...
if (!empty($user_id)) {
    ...
    if (isset($_POST['btnsubmit'])) {
        extract($_POST);
        echo $sql_query = "insert into payments (user_id,product_id,card_type,card_no,name_on_card,cvv,expiry_date,expiry_month) values('" . $user_id . "','" . $product_id . "','" . $card_type . "','" . $card_no . "','" . $name_on_card . "','" . $cvv . "','" . $expiry_date . "','" . $expiry_month . "')";
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="" method="post">
                            ...
                            if (isset($_GET['status']) && $_GET['status'] == "success") {
                                echo '<div class="style">Your Payment has been successfully completed.</div>';
                            }else{
                            ?>
                            <div class="row">
                                <div class="col-md-6">
