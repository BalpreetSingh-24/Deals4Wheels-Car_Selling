...
area can buy or sell his/her car. </p>
  ...
  <div class="skill-row">
    <img class="developerpic" src="images/harmanpreet singh.webp" alt="">
    <h3 class="skill1">HARMANPREET SINGH</h3>
    <p class="about">Hey There! I am the front end and backend developer of this website which is built using different web technologies langauges like HTML, CSS, Javascript and Bootstrap.
I love listening music, playing cricket,  golf and swimming. Apart from that if you want to know more about me then you can follow me on my social media platforms.
    </p>
    <div class="container-fluid">
      <a href="https://www.facebook.com/profile.php?id=100006321003903" class="icon"><i class="social-icon fab fa-facebook-f"></i></a>
      <a href="https://twitter.com/harmanpreets242" class="icon"><i class="social-icon fab fa-twitter"></i></a>
    <a href="https://www.instagram.com/harman_preets/" class="icon"> <i class="social-icon fab fa-instagram"></i></a>
    <a href="https://www.linkedin.com/in/harman-preets/" class="icon"> <i class="social-icon fab fa-linkedin-in size:3x"></i></a>
    <a href="mailto:harmanpreets142@gmail.com" class="icon"><i class="social-icon fas fa-envelope"></i></a>
...
<br><br><br><br>
  ...
  <footer>
    <div class="flex">
      <small>Copyright &copy; 2023 All rights reserved | Deals 4 Wheels</small>
      <ul id="nav-menu-container">
        <li><a href="index.php">HOME</a></li>
        <li><a href="about.php">ABOUT US</a></li>
        <li><a href="contact.php">CONTACT US</a></li>
