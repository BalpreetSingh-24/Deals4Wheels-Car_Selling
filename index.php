      ...
      <div class="flex">
        ...
        <div id="latest-news-container">
          <div class="latest-news-item">
            ...
            <span class="latest-news-text">Welcome to the First Version of Our Gaming Website.</span>
          </div>
        </div>
      </div>
    </section> -->
      ...
      <div class="flex">
        <div class="box">
          ...
          <div class="box-lower-section">
            <h4>SNAKE GAME</h4>
            <p>More you servive, More you score.</p>
        ...
        <div class="box">
          ...
          <img src="dragongamethumbnail.png" />
          <div class="box-lower-section">
            <h4>DRAGON TRAIL GAME</h4> -->
        ...
        <div class="box">
          <span class="badge adventure">New</span>
          <img src="simongamethumbnail.png" />
          <div class="box-lower-section">
            <h4>SIMON GAME</h4>
